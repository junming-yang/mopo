...
class MOPO():
    ...
    def learn_dynamics(self):
        ...
        model_log_infos['misc/norm_obs_mean'] = torch.mean(self.dynamics_model.obs_normalizer.mean).item()
        model_log_infos['misc/norm_obs_var'] = torch.mean(self.dynamics_model.obs_normalizer.var).item()
        model_log_infos['misc/norm_act_mean'] = torch.mean(self.dynamics_model.act_normalizer.mean).item()
        model_log_infos['misc/norm_act_var'] = torch.mean(self.dynamics_model.act_normalizer.var).item()
